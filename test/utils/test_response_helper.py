...
class TestUnitResponseHelper:
  ...
  @pytest.mark.parametrize("kwargs, exp_response, exp_status", [
    ({"message": "test message", "data": "test"}, {"status": "success", "data": "test", "message": "test message"}, 200),
    ({"message": "test message", "status": 202}, {"status": "success", "message": "test message"}, 202),
    ({}, {"status": "success"}, 200),
  ])
  ...
  @pytest.mark.parametrize("kwargs, exp_response, exp_status", [
    ({"message": "test message", "details": "test details"},
      {"status": "error", "error": {"message": "test message", "details": "test details", "code": 400}}, 400),
    ({"message": "test message", "errorcode": 404},
      {"status": "error", "error": {"message": "test message", "code": 404}}, 404),
  ...
  @pytest.mark.parametrize("details, exp_response", [
    (None,
      {"status": "error","error": { "code": 500, "message": "Unknown server error, try again."}}),
    ("test detail",
      {"status": "error","error": { "code": 500, "message": "Unknown server error, try again.", "details": "test detail"}})
